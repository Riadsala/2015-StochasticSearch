...
topSaccades = SaccsByPos{2:3,1};
botSaccades =SaccsByPos{2:3,4};
leftSaccades = SaccsByPos{4,2:3};
rightSaccades = SaccsByPos{1,2:3};
midSaccades = [SaccsByPos{2,2}; SaccsByPos{3,2};SaccsByPos{2,3}; SaccsByPos{3,3}];
figure
