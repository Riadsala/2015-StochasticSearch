function SalMap = AlasdairSaliencyMap(I, params, Location)
...
% Get Orientation channels and then combine;
OriMap = GenerateOriMaps(I, params);
SalMap = CombineOriMaps(OriMap, params, N);
