...
fout = fopen('targDetResponses.txt', 'w');
fprintf(fout, 'obs, beta, r, phi, resp\n');
...
for Pctr=1:2
     ...
     Results(Results(:,4)>1,4) = NaN;
     for i = 1:length(Results)
          fprintf(fout, '%d, %.2f, %d, %d, %d\n', Pctr, Results(i,1),Results(i,2),Results(i,3), Results(i,4));
     end
